...
public class Package {
    ...
    private static TreeSet<Item> items = new TreeSet<>(); // 物品集合,有序不可重复,如果重复了就不是01背包问题
    private static Item[] itemsArray = new Item[N + 1];
    private static int[][] memo = new int[N + 1][W + 1]; // 自底向上的备忘录,多申请1宽度和1高度是为了叙述方便
    private static HashSet<Item> itemsChosen = new HashSet<>(); // 被选择放进背包的物品
    ...
    public static void main(String[] args) {
        ...
        itemsChosen.forEach(System.out::println);
